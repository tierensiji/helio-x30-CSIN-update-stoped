su
#2.6加入新I/O调参，大幅优化应用启动速度。弃用interactive。大幅提高响应速度。
...
echo "0 2" > /proc/ppm/policy/userlimit_max_cpu_core
echo "1 4" > /proc/ppm/policy/userlimit_max_cpu_core
echo "2 2" > /proc/ppm/policy/userlimit_max_cpu_core
echo "0 449000" > /proc/ppm/policy/userlimit_min_cpu_freq
echo "1 279000" > /proc/ppm/policy/userlimit_min_cpu_freq
echo "2 974000" > /proc/ppm/policy/userlimit_min_cpu_freq
