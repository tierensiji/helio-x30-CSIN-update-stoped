...
echo "0-2,4-6" > /dev/cpuset/foreground/effective_cpus
...
echo "4-6" > /dev/cpuset/mzperf_ctrl/cpus
echo "4-6" > /dev/cpuset/mzperf_ctrl/effective_cpus
...
echo "0-2" > /dev/cpuset/system-background/effective_cpus
...
echo "0-2,4-6,8" > /dev/cpuset/cpus
echo "0-2,4-6,8" > /dev/cpuset/effective_cpus
