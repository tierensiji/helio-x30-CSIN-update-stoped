...
echo "2 2450000" > /proc/ppm/policy/userlimit_max_cpu_freq
#修改ctl
...
chmod 0755 /proc/cpufreq/cpufreq_oppidx
echo 15 > /proc/cpufreq/MT_CPU_DVFS_B/cpufreq_oppidx
echo 15 > /proc/cpufreq/MT_CPU_DVFS_LL/cpufreq_oppidx
echo 15 > /proc/cpufreq/MT_CPU_DVFS_L/cpufreq_oppidx
echo 15 > /proc/cpufreq/cpufreq_oppidx
#修改作用顺序
