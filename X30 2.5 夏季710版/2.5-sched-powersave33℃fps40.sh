...
echo "28000 1145000:38000 98000:38000 1347000:38000 1421000:48000 1512000:48000" > /sys/devices/system/cpu/cpufreq/interactive/above_hispeed_delay
#调节升频频率
chmod 0777 /sys/devices/system/cpu/cpufreq/interactive/hispeed_freq
echo 1421000 > /sys/devices/system/cpu/cpufreq/interactive/hispeed_freq
#调节升频所需负载条件
...
echo "10 249000:20 648000:30 830000:50 1145000:70 1347000:80 1512000:86 1678000:95 20 484000:30 687000:40 1200000:50 1571000:60 1818000:70 2040000:85 2117000:91 2157000:99 15 328000:25 771000:35 1329000:45 1766000 50 2057000:70 2318000:85 2408000:91 2452000:99" > /sys/devices/system/cpu/cpufreq/interactive/target_loads
#调节CPU负载采样间隔
...
echo "4-6" > /dev/cpuset/background/effective_cpus
...
echo "5-8" > /dev/cpuset/foreground/cpus
echo "5-8" > /dev/cpuset/foreground/effective_cpus
...
echo "5-8" > /dev/cpuset/top-app/cpus
echo "5-8" > /dev/cpuset/top-app/effective_cpus
...
echo 5 > /proc/cpufreq/MT_CPU_DVFS_B/cpufreq_oppidx
...
echo 0 > /proc/gpufreq/gpufreq_limited_power
