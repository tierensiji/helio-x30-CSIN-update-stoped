...
echo "18000 1145000:28000 98000:28000 1347000:38000 1421000:38000 1512000:38000" > /sys/devices/system/cpu/cpufreq/interactive/above_hispeed_delay
#调节升频频率
...
echo "2-9" > /dev/cpuset/top-app/cpus
echo "2-9" > /dev/cpuset/top-app/effective_cpus
