...
echo "4-5" > /dev/cpuset/background/effective_cpus
...
echo "6-8" > /dev/cpuset/foreground/cpus
echo "6-8" > /dev/cpuset/foreground/effective_cpus
...
echo "4-9" > /dev/cpuset/cpus
echo "4-9" > /dev/cpuset/effective_cpus
...
echo 15 > /proc/cpufreq/MT_CPU_DVFS_LL/cpufreq_oppidx
